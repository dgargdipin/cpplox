...
execute_process(
  COMMAND "/usr/bin/git" show-ref "58d77fa8070e8cec2dc1ed015d66b454c8d78850"
  WORKING_DIRECTORY "/home/dgargdipin/dev/lox/cmake-build-debug-wsl/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/dgargdipin/dev/lox/cmake-build-debug-wsl/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/dgargdipin/dev/lox/cmake-build-debug-wsl/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
